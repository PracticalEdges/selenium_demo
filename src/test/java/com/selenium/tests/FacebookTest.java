...
public class FacebookTest {
    ...
    void setUp() {
        ...
        System.setProperty("webdriver.chrome.driver", "C:\\Users\\sarth\\Documents\\selenium_demo\\driver\\chromedriver.exe");
    ...
    void teststeps() throws InterruptedException {
        ...
        email_input.sendKeys("Your user-id");
        WebElement password_input = driver.findElement(By.xpath("//*[@id=\"pass\"]"));
        password_input.sendKeys("your pass");
